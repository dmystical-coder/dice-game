...
contract RiggedRoll is Ownable {
    ...
    function riggedRoll() external onlyOwner {
        ...
        // Predict the roll by using the same formula as DiceGame
        ...
        // Only roll if we predict a win (rolls 0-5 win)
        if (predictedRoll > 5) {
            revert UnwinningRoll();
        }

        // If we have a winning roll, call the DiceGame contract
